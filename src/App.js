    ...
    <div className="App">
      ...
      {activeTab == "About Me" && (
        ...
        <p>
          ...
          are my biggest hobby and I want to know as much as I can. Anything
          from gaming all night with my friends to researching new tech. I love
          3d art, I'm getting into Blender and photoshop so I can further my
          hobby. Hopefully by the end of this program I have the capabilites to
          be a full stack web developer and can get my foot in the field!
        </p>
        </>
      )}
